...
const CreateProject: React.FC = () => {
  ...
  const handleAddYoutubeLink = () => {
    if (newYoutubeLink.trim() && !formData.media.youtube_links.includes(newYoutubeLink.trim())) {
      const updatedMedia = {
        ...formData.media,
  ...
  const handleAddPdfLink = () => {
    if (newPdfLink.trim() && !formData.media.pdf_links.includes(newPdfLink.trim())) {
      const updatedMedia = {
        ...formData.media,
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <Card className="border border-gray-100">
              <CardHeader>
                ...
                <CardDescription className="font-inter">Add videos, photos, and documents to showcase your project</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {/* YouTube Links */}
                <div className="space-y-2">
